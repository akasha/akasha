...
Buildr::ReleaseTool.define_release_task do |t|
  ...
  t.patch_changelog('akasha/akasha', :api_diff_directory => "#{WORKSPACE_DIR}/api-test", :api_diff_website => 'https://akasha.github.io/akasha-java/api-diff/?key=akasha-java&')
