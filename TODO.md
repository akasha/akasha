...
* Consider explicitly representing JsIterable in IDL either as a type or an annotation on a `sequence<>` and have
  a pass that expands maplike, and iterables into regular operations.
