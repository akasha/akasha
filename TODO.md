...
* Extract a separate module for testing java-generating generators. Move `AbstractTest` from
  `jsinterop-generator` and `react4j-generator` projects to this module.
