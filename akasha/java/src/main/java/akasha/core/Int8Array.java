  ...
  implements IntegerTypedArray, JsIterable<Int8Array.Entry>
{
   ...
   */
  @JsNonNull
  public native Int8Array fill( byte value, int start, int end );
   ...
   */
  @JsNonNull
  public native Int8Array fill( byte value, int start );
   ...
   */
  @JsNonNull
  public native Int8Array fill( byte value );
   ...
   */
  public native boolean includes( byte searchElement, int fromIndex );
   ...
   * @see <a href="https://tc39.es/ecma262/multipage/indexed-collections.html#sec-%25typedarray%25.prototype.includes">(ECMAScript) # sec-%typedarray%.prototype.includes</a>
   */
  public native boolean includes( byte searchElement );
   ...
   */
  public native int indexOf( byte searchElement, int fromIndex );
   ...
   * @see <a href="https://tc39.es/ecma262/multipage/indexed-collections.html#sec-%25typedarray%25.prototype.indexof">(ECMAScript) # sec-%typedarray%.prototype.indexof</a>
   */
  public native int indexOf( byte searchElement );
   ...
   */
  public native int lastIndexOf( byte searchElement, int fromIndex );
   ...
   * @see <a href="https://tc39.es/ecma262/multipage/indexed-collections.html#sec-%25typedarray%25.prototype.lastindexof">(ECMAScript) # sec-%typedarray%.prototype.lastindexof</a>
   */
  public native int lastIndexOf( byte searchElement );
