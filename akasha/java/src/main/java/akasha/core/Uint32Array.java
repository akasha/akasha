...
public class Uint32Array
  extends JsObject
  implements IntegerTypedArray, JsIterable<Uint32Array.Entry>
{
  /**
   ...
   */
  @JsNonNull
  public native Uint32Array fill( int value, int start, int end );
   ...
   */
  @JsNonNull
  public native Uint32Array fill( int value, int start );
   ...
   */
  @JsNonNull
  public native Uint32Array fill( int value );
  ...
  {
    void item( int value, int index, @JsNonNull Uint32Array iterable );
  }
