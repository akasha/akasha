...
public class Promise<T>
{
   ...
   * @param promises the promises.
   * @param <V>      the component type of the promise returned.
   * @return A promise that yields the value of the first promise in the given iterable to fulfill or an {@link akasha.core.AggregateError} containing the reasons for all the rejected promises.
