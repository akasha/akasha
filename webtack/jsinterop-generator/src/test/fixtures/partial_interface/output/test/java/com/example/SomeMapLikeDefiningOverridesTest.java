...
public final class SomeMapLikeDefiningOverridesTest {
  ...
  public static boolean has(@Nonnull String key, SomeMapLikeDefiningOverrides $instance) {
    return $instance.has( key );
  }

  public static Double get(SomeMapLikeDefiningOverrides $instance, @Nonnull String key) {
