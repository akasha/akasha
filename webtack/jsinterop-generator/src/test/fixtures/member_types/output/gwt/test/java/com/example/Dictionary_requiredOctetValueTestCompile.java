...
public final class Dictionary_requiredOctetValueTestCompile {
  ...
  public static short requiredOctetValue(final Dictionary_requiredOctetValue $instance) {
    return $instance.requiredOctetValue();
  }

  public static void setRequiredOctetValue(final Dictionary_requiredOctetValue $instance,
  ...
  public static Dictionary_requiredOctetValue.Builder requiredOctetValue(
      final Dictionary_requiredOctetValue.Builder $instance, final short requiredOctetValue) {
    return $instance.requiredOctetValue( requiredOctetValue );
  }
}
