...
@JsType(
    ...
    name = "AnonymousIndexedAccessorsUnsignedLongLong"
)
public class AnonymousIndexedAccessorsUnsignedLongLong {
  protected AnonymousIndexedAccessorsUnsignedLongLong() {
  }
