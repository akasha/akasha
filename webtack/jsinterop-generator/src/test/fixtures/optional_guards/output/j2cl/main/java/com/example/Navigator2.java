...
public class Navigator2 {
  ...
  public final boolean isGetGamepadsSupported() {
    return "true".equals( System.getProperty( "com.example.is__Navigator2_getGamepads__supported" ) ) ? true : "false".equals( System.getProperty( "com.example.is__Navigator2_getGamepads__supported" ) ) ? false : Js.asPropertyMap( this ).has( "getGamepads" );
  }
