...
public final class TransitionEventInitTestCompile {
  ...
  public static String propertyName3(final TransitionEventInit $instance) {
    return $instance.propertyName3();
  }

  public static void setPropertyName3(final TransitionEventInit $instance, String propertyName3) {
    $instance.setPropertyName3( propertyName3 );
  }
  ...
  public static TransitionEventInit.Builder propertyName3(
      final TransitionEventInit.Builder $instance, final String propertyName3) {
    return $instance.propertyName3( propertyName3 );
  }
  ...
  public static TransitionEventInit.Builder propertyName2(
      final TransitionEventInit.Builder $instance, final String propertyName2) {
    return $instance.propertyName2( propertyName2 );
  }
}
