...
interface JSON {
   ...
   * Throws a {@link TypeError} if a circular reference is found or an attempt is made to stringify a BigInt.
   *
   ...
   * Throws a {@link SyntaxError} if the string to parse is not valid JSON.
   *
