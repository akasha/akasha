...
typedef (
  ...
  WEBGL_debug_shaders or
  WEBGL_depth_texture or
  WEBGL_lose_context or
  WEBGL_multi_draw
...
typedef (
  ...
  OES_texture_half_float or
  OES_vertex_array_object or
  WEBGL_color_buffer_float or
  WEBGL_draw_buffers or
  WebGLCommonExtension
) WebGL1Extension;
